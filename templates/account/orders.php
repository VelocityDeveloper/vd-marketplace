...
use VelocityMarketplace\Modules\Shipping\ShippingController;
    ...
    <?php elseif ($invoice !== '') : ?>
        ...
        <div class="card border-0 shadow-sm mb-3"><div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                    <div><strong><?php echo esc_html__('Invoice:', 'velocity-marketplace'); ?></strong> <?php echo esc_html($invoice_meta); ?></div>
                ...
                <div class="col-md-6">
                    ...
                    <div><strong><?php echo esc_html__('Total Ongkir:', 'velocity-marketplace'); ?></strong> <?php echo esc_html(number_format($shipping_total > 0 ? $shipping_total : (float) ($shipping['cost'] ?? 0), 0, ',', '.')); ?></div>
            ...
            <hr>
            <div class="table-responsive"><table class="table table-sm table-hover mb-0"><thead><tr><th><?php echo esc_html__('Produk', 'velocity-marketplace'); ?></th><th class="text-end"><?php echo esc_html__('Harga', 'velocity-marketplace'); ?></th><th class="text-center"><?php echo esc_html__('Qty', 'velocity-marketplace'); ?></th><th class="text-end"><?php echo esc_html__('Subtotal', 'velocity-marketplace'); ?></th></tr></thead><tbody>
            ...
            <?php endforeach; ?>
                ...
                <tr><th colspan="3" class="text-end"><?php echo esc_html__('Subtotal Produk', 'velocity-marketplace'); ?></th><th class="text-end"><?php echo esc_html(number_format((float) get_post_meta($order_id, 'vmp_subtotal', true), 0, ',', '.')); ?></th></tr>
                <tr><th colspan="3" class="text-end"><?php echo esc_html__('Total Ongkir', 'velocity-marketplace'); ?></th><th class="text-end"><?php echo esc_html(number_format($shipping_total > 0 ? $shipping_total : (float) ($shipping['cost'] ?? 0), 0, ',', '.')); ?></th></tr>
                <?php if ($coupon_product_discount > 0) : ?>
                    <tr><th colspan="3" class="text-end"><?php echo esc_html__('Diskon Produk', 'velocity-marketplace'); ?></th><th class="text-end text-success">-<?php echo esc_html(number_format($coupon_product_discount, 0, ',', '.')); ?></th></tr>
                <?php endif; ?>
                <?php if ($coupon_shipping_discount > 0) : ?>
                    <tr><th colspan="3" class="text-end"><?php echo esc_html__('Diskon Ongkir', 'velocity-marketplace'); ?></th><th class="text-end text-success">-<?php echo esc_html(number_format($coupon_shipping_discount, 0, ',', '.')); ?></th></tr>
                <?php endif; ?>
                <?php if ($coupon_discount > 0 && $coupon_product_discount <= 0 && $coupon_shipping_discount <= 0) : ?>
                    <tr><th colspan="3" class="text-end"><?php echo esc_html__('Diskon Kupon', 'velocity-marketplace'); ?></th><th class="text-end text-success">-<?php echo esc_html(number_format($coupon_discount, 0, ',', '.')); ?></th></tr>
                <?php endif; ?>
                <tr><th colspan="3" class="text-end"><?php echo esc_html__('Total', 'velocity-marketplace'); ?></th><th class="text-end text-danger"><?php echo esc_html(number_format($total, 0, ',', '.')); ?></th></tr>
            </tfoot></table></div>
                                ...
                                <div class="border rounded p-3">
                                    ...
                                    <form method="post" enctype="multipart/form-data" class="row g-2">
                                        ...
                                        <div class="col-12 text-end">
                                            <button type="submit" class="btn btn-sm btn-dark"><?php echo esc_html($existing_review ? __('Perbarui Ulasan', 'velocity-marketplace') : __('Kirim Ulasan', 'velocity-marketplace')); ?></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
            ...
            <?php if (!empty($shipping_groups)) : ?>
                <div class="mt-3">
                    <h3 class="h6 mb-2"><?php echo esc_html__('Pengiriman per Toko', 'velocity-marketplace'); ?></h3>
                    <div class="row g-3">
                                ...
                                <div class="border rounded p-3">
                                    <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                                        <div>
                                            ...
                                            <div class="small text-muted"><?php echo esc_html(sprintf(__('Resi: %s', 'velocity-marketplace'), ($group_receipt_no !== '' ? $group_receipt_no : '-'))); ?></div>
                                        </div>
                                        <div class="text-end">
                                            <div class="small text-muted"><?php echo esc_html__('Pengiriman', 'velocity-marketplace'); ?></div>
                ...
                <div class="d-flex flex-wrap gap-2 mt-2">
                    <?php foreach ($order_seller_ids as $seller_contact_id) : $seller_user = get_userdata($seller_contact_id); ?>
                        <a href="<?php echo esc_url(add_query_arg(['tab' => 'messages', 'message_to' => $seller_contact_id, 'message_order' => $order_id])); ?>" class="btn btn-sm btn-outline-dark">
                            <?php echo esc_html(sprintf(__('Pesan %s', 'velocity-marketplace'), ($seller_user && $seller_user->display_name !== '' ? $seller_user->display_name : __('Penjual', 'velocity-marketplace')))); ?>
                        </a>
                    <?php endforeach; ?>
                </div>
            <?php endif; ?>
